      ...
      <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
          <img
            ...
            alt="logo"
          />
          <span class="ml-3 text-xl text-myCyan">They call me , Naveen</span>
        </a>
        <p class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4 text-myCyan">
          © 2022-23 NM : Naveen Malhotra —
          <a
        ...
        <span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start text-myCyan">
          ...
          <a class="ml-3 text-gray-500" href="https://twitter.com/Naveen_2970">
            <svg
              fill="currentColor"
              stroke-linecap="round"
              stroke-linejoin="round"
